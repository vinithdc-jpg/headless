...
export default function ContactHero() {
  return (
    <section className="relative overflow-hidden bg-[#071B3A]">
      ...
      <div className="absolute -top-32 -right-24 w-96 h-96 rounded-full bg-[#C9A227]/10 blur-3xl" aria-hidden />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-20 sm:py-28 lg:py-36">
        <div className="max-w-3xl">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl md:text-7xl font-semibold leading-tight text-white">
            Begin Your
            <br />
            <span className="italic font-normal text-[#C9A227]">Risk Conversation</span>
          </h1>

          <p className="mt-6 sm:mt-8 text-lg md:text-xl leading-9 text-slate-300 max-w-2xl">
            Whether you&apos;re looking for expert insurance advice, requesting a quotation,
            or reporting a claim, our specialists are ready to help you find the right
            solution.
          </p>

          <div className="mt-10 sm:mt-12 flex flex-wrap gap-4 sm:gap-5">
            <Link
              href="/quote"
